...
export class Person {
  ...
  @OneToMany(() => Table, (table) => table.persons, {
    nullable: true,
    eager: false,
  })
  waiterTables?: Table[];

  @ManyToOne(() => Restaurant, (restaurant) => restaurant.emplooyes)
  restaurant?: Restaurant;

  @OneToOne(() => Restaurant, (restaurant) => restaurant.owner)
  @JoinColumn({ referencedColumnName: 'id', name: 'own_restaurant_id' })
  personRestaurant?: Restaurant;
}
